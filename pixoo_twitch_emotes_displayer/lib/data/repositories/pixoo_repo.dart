...
import 'package:pixoo_twitch_emotes_displayer/data/models/find_same_lan_device_response.dart';
...
class PixooDeviceRepo {
  static Future<List<PixooDevice>> getSameLANDevices() {
    return PixooAPI.findSameLANDevices().then(
      (res) => res.data != null ? FindSameLANDevicesResponse.fromJson(res.data!).deviceList : [],
    );
  }
}
